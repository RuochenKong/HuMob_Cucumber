...
def cal_bleu(val_data, merged, ifDTW = False):
    ...
    return geobleu_val/len(unique_id), dtw_val/len(unique_id) if ifDTW else geobleu_val/len(unique_id)
...
if __name__ == '__main__':
    ...
    if '-bleu' in sys.argv:
        calDTW = '-dtw' in sys.argv
        cal_bleu(val_data,reformat_data, calDTW)